...
insert into products (id, business_id, name, unit, cost_price, reference_price, stock_cached, low_stock_threshold) values
  ('b1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'Cola', 'piece', 3000, 5000, 10, 5);
