-- When an offline bill references a customer_id that is gone from this
-- database (stale Drift cache after reset), recreate a portal-off customer
-- so create_bill can proceed. Prefer phone/shop remap first.
