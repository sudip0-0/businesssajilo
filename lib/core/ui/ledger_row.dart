...
double ledgerDateColumnWidthFor(double maxWidth) =>
    maxWidth >= 900 ? 200.0 : 100.0;

bool _isCompactLedgerWidth(double maxWidth) => maxWidth < 600;
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final dateWidth = ledgerDateColumnWidthFor(maxWidth);
        final compact = _isCompactLedgerWidth(maxWidth);
...
/// Kept for callers that still need a window-based date width.
double ledgerDateColumnWidth(BuildContext context) =>
    ledgerDateColumnWidthFor(MediaQuery.sizeOf(context).width);
